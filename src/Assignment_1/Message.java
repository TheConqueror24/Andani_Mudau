...
public class Message  {
    ...
    while (true) { 
        String optionPicker = JOptionPane.showInputDialog(null, "Welcome to QuickChat, Andani!\n" + "1. Send Messages\n" + "2. Show Recently Sent Messages\n" + "3. Quit","QuickChat Menu",JOptionPane.QUESTION_MESSAGE );
        ...
        switch (optionPicker) {
            case "1": // Send Messages
                try {
                    int messageCount = Integer.parseInt(JOptionPane.showInputDialog(
                        null, "Enter amount of messages to send:",JOptionPane.QUESTION_MESSAGE));
                    
                    for (int i = 0; i < messageCount; i++) {
                        
                        String content = JOptionPane.showInputDialog(null, "Enter message" + (i+1) + ":" , JOptionPane.QUESTION_MESSAGE);
                        ...
                        String choice = JOptionPane.showInputDialog(null,
                            "Message Options for message " + (i+1) + ":\n" + "1. Send Message\n" +"2. Disregard Message\n" + "3. Store Message", JOptionPane.QUESTION_MESSAGE);
            ...
            default:
                JOptionPane.showMessageDialog(null, "Incorrect option selected!","Error",JOptionPane.ERROR_MESSAGE);
        }
    }
}
